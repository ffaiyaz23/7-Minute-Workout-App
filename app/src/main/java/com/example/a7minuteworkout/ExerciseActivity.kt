        ...
        restTimer = object : CountDownTimer(10000, 100) {
            override fun onTick(millisUntilFinished: Long) {
                ...
                binding?.progressBar?.progress =
                    (millisUntilFinished/1000).toInt() // Indicates progress bar progress
                binding?.tvTimer?.text =
                    (millisUntilFinished/1000).toString()  // Current progress is set to text view in terms of seconds.
            }
...
// changing the upcoming exercise label and name visibility.)
    ...
    private fun setExerciseProgressBar() {
        ...
        exerciseTimer = object : CountDownTimer(exerciseTimerDuration * 1000, 100) {
            override fun onTick(millisUntilFinished: Long) {
                exerciseProgress++
